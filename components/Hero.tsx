      ...
      <Container>
       ...
       <div className="grid lg:grid-cols-[50%_50%] items-center gap-8">
          ...
          <div>
            ...
            <h1 className="hero-title mb-6 font-serif text-5xl leading-tight text-[#3d2d22] sm:text-6xl md:text-7xl md:whitespace-nowrap lg:text-8xl lg:leading-none">
              Cloud & Crunch
            </h1>

            <p className="hero-subtitle mb-10 font-serif text-3xl italic text-[#8b5a2b]">
              Delicia e outras sobremesas artesanais.
            </p>
            ...
            <p className="hero-description max-w-xl text-lg leading-9 text-stone-700">
              ...
              refeição num momento especial. Da nossa Delicia
