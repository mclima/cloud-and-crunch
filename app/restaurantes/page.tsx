...
const products = [
  ...
  {
    name: 'Mousse Maracujá mal cheia',
    format: 'Tacinha',
    capacity: '240ml',
    minQuantity: '12',
    price: '1.65',
...
const packaging = [
  ...
  { item: 'Tulipa Preta', capacity: 'Queques', cardboard: '0.045', plastic: '' },
  { item: 'Tulipa Creme', capacity: 'Queques', cardboard: '0.062', plastic: '' },
  { item: 'Forma Cupcake Branca', capacity: 'Queques', cardboard: '0.015', plastic: '' },
